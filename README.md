...
The provided GitHub Action will also publish a third "metadata" package with just the namespace, eg: `ghcr.io/ran-dall/devcontainer-features-anaconda`.  This contains information useful for tools aiding in Feature discovery.
